...
Contracts &mdash; Use Cases
===========================

Introduction
------------

SG21 has gathered a large number of use cases for contracts between teh WG21
...
some level of important to the community for each individual use case.

Each use case has been assigned an identifier that can be used to reference
these use cases in other papers, which will hopefully be stable.  We expect
this content to evolve in a number of ways:

* Long descriptions of these use cases (found at the bottom of this document)
could all benefit from additional contributions.
* Future poll results, analysis of these poll results, and other analysis of
this data will help guide group decisions on further SG21 progress.
* New and old contracts proposals, along with the current possibilities with
no language changes at all, should be explored and measured in relation to how
they satisfy these use cases.

Polling
-------

Polling occurred through SurveyMonkey between the July 2019 WG21 Cologne meeting
and the November 2019 WG21 Belfast meeting.   Participants were asked to choose
from three answers for each of the 195 different use cases:

* Must Have (Must = 2)
* Nice to Have (Nice = 1)
* Not important (Not = 0)

Participants were also able to not answer at all for a given question (N/A),
